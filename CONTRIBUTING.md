...
> **The spec changes first. Then the code. Never the reverse.**
...
4. **Review.** The spec change should be reviewed and agreed upon before any
   implementation begins.

5. **Implement.** Write or modify code to match the approved spec. If you
   discover during implementation that the spec is wrong or incomplete, stop,
   update the spec, then continue coding.

6. **Verify.** Confirm the implementation matches the spec. If reality diverges
