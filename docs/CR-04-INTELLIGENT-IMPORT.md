...
Status: Partial — Target Detection (P4, PR #253) + Session Grouping (P5, PR #301) + Capture Analysis (P6, PR #302) + Narrowband Detection (P7, PR #303) + IPC layer (P8, PR #304) shipped; P9 (Import Review UI) + P10 (AI stub hook) in flight
