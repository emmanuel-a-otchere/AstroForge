...
|-------|--------|-----------|
| P0 | in_progress | this PR (doc + plan + orientation + README pointer) |
| P1 | pending | `core::import_scan` + `core::import_metadata` (scan + metadata extraction + content hash + duplicate detection) |
